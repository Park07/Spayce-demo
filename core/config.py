...
PERSON_CLASS_ID = 0
YOLO_MODEL_NAME = "face_yolov8.pt"
PERSON_CLASS_ID = 0
...
DEFAULT_GRID_ZONES = [
    {"name": "Zone_TL", "type": "entry",      "rect": (0.0,  0.0,  0.33, 0.5)},
    {"name": "Zone_TC", "type": "bottleneck",  "rect": (0.33, 0.0,  0.66, 0.5)},
    {"name": "Zone_TR", "type": "exit",        "rect": (0.66, 0.0,  1.0,  0.5)},
    {"name": "Zone_BL", "type": "entry",       "rect": (0.0,  0.5,  0.33, 1.0)},
    {"name": "Zone_BC", "type": "bottleneck",  "rect": (0.33, 0.5,  0.66, 1.0)},
    {"name": "Zone_BR", "type": "exit",        "rect": (0.66, 0.5,  1.0,  1.0)},
]
...
# Use grid zones + adjacency as default
ZONE_ADJACENCY = GRID_ZONE_ADJACENCY
